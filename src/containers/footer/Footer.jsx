  ...
  return (
    <div className='footer-content'>
      <div className="footer-content-left">
        ...
        <p className='footer-content-left-copyright'>© 2022 Lenin Speel Perk. All rights reserved. Designed by Lenin Speel Perk.</p>
      </div>
      <div className="footer-content-right">
        <div className="footer-content-right-icon">
          ...
          <div className="footer-content-right-icon-twitter">
            <a href="https://twitter.com/PerkSpeel"><img src={twitter} alt="" /></a>
          </div>
          <div className="footer-content-right-icon-instagram">
            <a href="https://www.instagram.com/lenin_masss/"><img src={instagram} alt="" /></a>
          </div>
          <div className="footer-content-right-icon-youtube">
            <a href="https://www.youtube.com/channel/UChI9vij1d2ZRQHVa0RUePXw"><img src={youtube} alt="" /></a>
          </div>
          <div className="footer-content-right-icon-github">
            <a href="https://github.com/LeninSpeelPerk"><img src={github} alt="" /></a>
          </div>
        </div>
      </div>
    </div>
